          ...
          <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
            <div className="lg:py-24">
              ...
              <div className="mt-4 sm:mt-3">
                  ...
                  <button className="text-center font-justanotherhand text-5xl inline-flex w-full py-3 px-4 rounded-md shadow bg-pale-yellow text-teal focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900 items-center"><Ethereum className="h-8 mr-3"/>mint free: 0 eth</button> 
                  </div>
              </div>
            </div>
          </div>
